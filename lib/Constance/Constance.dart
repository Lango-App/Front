...
class ConstanceData {
  ...
  static String par = "${bseImageUrl}arrowleft.png";
  static String pset= "${bseImageUrl}setting.png";
  static String pav= "${bseImageUrl}avatar_pr.png";
  static String pfl= "${bseImageUrl}follow.png";
  static String pms= "${bseImageUrl}massage.png";
  static String psa= "${bseImageUrl}psa.png";
